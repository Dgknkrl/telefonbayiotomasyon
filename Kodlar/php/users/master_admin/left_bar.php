<h2>Ürün İşlemleri</h2>
      ...
      <ul>
        <li><a href="../depo_islem/depo_gor.php">Depo Görüntüleme</a></li>
        <li><a href="../depo_islem/depo_ekle.php">Depo Ekleme</a></li>
        <li><a href="../depo_islem/depo_sil.php">Depo Silme</a></li>
      </ul>
